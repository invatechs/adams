        ...
        app.post('/' + project.webHookPath, function(request, response) {
          ...
          try {
            ...
            if(notificationData.hasOwnProperty('error')) {
              ...
              var logProject = project;
              logProject.password = 'removed for log';
              console.log('@queued hook: notifications: ' + isNotificationEnabled + '; project: ' + JSON.stringify(logProject));
